  ...
  testFn(
    ...
    async () => {
      ...
      const result = await agentManager.promptUntilDone(
        spawnResult.id,
        `Create a file called src/greeting.ts with a simple function that returns "Hello".
